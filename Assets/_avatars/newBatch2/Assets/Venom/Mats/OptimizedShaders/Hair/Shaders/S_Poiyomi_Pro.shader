Shader "Hidden/.poiyomi/★ Poiyomi Pro ★/Hair-Hair"
{
    Properties
    {
        [HideInInspector] shader_is_using_thry_editor ("", Float) = 0
        [HideInInspector] shader_master_label ("<color=#000000ff>Poiyomi Pro V7.3.021</color>", Float) = 0
        ...
        [HideInInspector] m_start_lightingAdvanced ("Additive Lighting (Point/Spot)--{reference_property:_LightingAdditiveEnable,button_right:{text:Tutorial,action:{type:URL,data:https://www.youtube.com/watch?v=at3p5yRRVU0&list=PL4_Gy3VRJSmbXfQSldzUiChgABQsoBlLw&index=12},hover:YouTube}}", Float) = 0
...
#define PROPM_START_EMISSION1AUDIOLINK 1
#define PROP_ENABLEEMISSION1STRENGTHAUDIOLINK 1
...
#define PROP_GLITTERFREQUENCY 5000
#define PROP_GLITTERJITTER 2
#define PROP_GLITTERSPEED 10
#define PROP_GLITTERSIZE 1
#define PROP_GLITTERCONTRAST 0
...
#define PROP_GLITTERFREQUENCYLINEAREMISSIVE 75.1
...
#define PROP_AUDIOLINKANIMTOGGLE 0
...
#define PROP_ENABLEIRIDESCENCE 1
...
#define PROP_IRIDESCENCENORMALINTENSITY 0
#define PROP_IRIDESCENCENORMALUV 0
#define PROP_IRIDESCENCEMASKUV 0
#define PROP_IRIDESCENCENORMALSELECTION 1
#define PROP_IRIDESCENCEINTENSITY 1.75
#define PROP_IRIDESCENCEADDBLEND 0.454
...
#define PROPM_START_IRIDESCENCEAUDIOLINK 1
