Shader "Hidden/.poiyomi/★ Poiyomi Pro ★/Shoes-Shoes"
{
    Properties
    {
...
#define PROP_MAINBRIGHTNESS -0.35
...
#define PROP_MATCAPINTENSITY 0.73
#define PROP_MATCAPLIGHTMASK 0
#define PROP_MATCAPREPLACE 0.472
