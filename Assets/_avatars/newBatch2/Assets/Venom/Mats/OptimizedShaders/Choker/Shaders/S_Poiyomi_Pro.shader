Shader "Hidden/.poiyomi/★ Poiyomi Pro ★/Choker-Choker"
{
    Properties
    {
...
#define PROP_MATCAP
#define PROP_MATCAPBORDER 0.423
...
#define PROP_MATCAPREPLACE 0.174
#define PROP_MATCAPMULTIPLY 0.483
