Shader "Hidden/.poiyomi/★ Poiyomi Pro ★/Tongue-Tongue"
{
    Properties
    {
...
#define PROP_MATCAPREPLACE 0.339
#define PROP_MATCAPMULTIPLY 1
#define PROP_MATCAPADD 0.223
...
#define PROP_SPECULARMETALLIC 0.553
