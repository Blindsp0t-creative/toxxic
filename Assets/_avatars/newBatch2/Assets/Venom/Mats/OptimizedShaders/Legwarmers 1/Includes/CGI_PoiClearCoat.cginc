    ...
    */
    ...
    void calculateAndApplyClearCoat(inout float4 finalColor)
    {
        ...
        float3 creflViewDir = getClearcoatAnisotropicReflectionVector(poiCam.viewDir, poiMesh.binormal, poiMesh.tangent, poiMesh.normals[0], clearcoatRoughness, float(0));
