Shader "Hidden/.poiyomi/Patreon/★ Fur ★/Legwarmers 1-Legwarmers 1"
{
    Properties
    {
...
#define PROPGEOMETRYSHADER_ENABLED 1
#define PROP_FORGOTTOLOCKMATERIAL 1
#define PROP_SHADEROPTIMIZERENABLED 0
#define PROP_LOCKTOOLTIP 0
#define PROP_MODE 0
#define PROPM_FUROPTIONS 0
#define PROP_FURTEXTURE
#define PROP_FURHEIGHTMAP
#define PROP_FURMASK
#define PROP_FURLENGTH 0.075
#define PROP_FURGRAVITYSTRENGTH 1
#define PROP_FURLAYERS 23
#define PROP_FURAO 1
#define PROPM_START_FURADVANCED 1
#define PROP_FURTIPALPHA 1
#define PROP_FURFADESTART 0
#define PROP_AORAMPMIN 0
#define PROP_AORAMPMAX 1
#define PROP_FURHEIGHTMAPMIN 0
#define PROP_FURHEIGHTMAPMAX 1
#define PROP_FURMINDISTANCE 0
#define PROP_FURMAXDISTANCE 25
#define PROPM_END_FURADVANCED 0
...
#define PROP_MAINHUESHIFT 0.039
#define PROP_MAINHUESHIFTSPEED 0
#define PROP_SATURATION 0.25
#define PROP_MAINBRIGHTNESS -0.079
