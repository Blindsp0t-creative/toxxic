Shader "Hidden/Locked/.poiyomi/Old Versions/8.1/Poiyomi Toon/a13a9b5c672d77b469fe75099e401dc3"
{
	Properties
	{
		...
		[HideInInspector] m_start_MainHueShift_BabyHairs6 ("Color Adjust--{reference_property:_MainColorAdjustToggle,button_help:{text:Tutorial,action:{type:URL,data:https://www.poiyomi.com/color-and-normals/color-adjust},hover:Documentation}}", Float) = 0
		...
		_MainHueShift_BabyHairs6 ("Hue Shift--{condition_showS:(_MainHueShiftToggle==1)}", Range(0, 1)) = 0
		...
		[HideInInspector] m_end_MainHueShift_BabyHairs6 ("Hue Shift", Float) = 0
 ...
 #define OPTIMIZER_ENABLED 
			...
			float _MainHueShift_BabyHairs6;
			...
			{
				poiFragData.alpha = saturate(poiFragData.alpha + (0.01 /*_AlphaMod*/));
			...
			void calculateShading(inout PoiLight poiLight, inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiCam poiCam)
			{
				...
				#endif
				float shadowStrength = (0.129 /*_ShadowStrength*/) * poiLight.shadowMask;
				#ifdef POI_PASS_OUTLINE
			...
			{
				float smoothness = (0.438 /*_MochieRoughnessMultiplier*/);
				...
				#endif
				reflectionMask *= (0.322 /*_MochieReflectionStrength*/);
				specularMask *= (0.096 /*_MochieSpecularStrength*/);
			...
			float4 frag(VertexOut i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				#if defined(PROP_BUMPMAP) || !defined(OPTIMIZER_ENABLED)
				poiMesh.tangentSpaceNormal = UnpackScaleNormal(POI2D_SAMPLER_PAN_STOCHASTIC(_BumpMap, _MainTex, poiUV(poiMesh.uv[(0.0 /*_BumpMapUV*/)].xy, float4(4,4,0,0)), float4(0,0,0,0), (0.0 /*_BumpMapStochastic*/)), (0.0 /*_BumpScale*/));
				#else
				...
				#endif
				poiFragData.baseColor = mainTexture.rgb * poiThemeColor(poiMods, float4(0.02515705,0.04183738,0.06955751,1).rgb, (0.0 /*_ColorThemeIndex*/));
				poiFragData.alpha = mainTexture.a * float4(0.02515705,0.04183738,0.06955751,1).a;
				...
				{
					float shift = _MainHueShift_BabyHairs6;
					#ifdef POI_AUDIOLINK
