Shader "Hidden/Locked/.poiyomi/Old Versions/8.1/Poiyomi Toon/155964f205aa5604db2ad681ac9a900b"
{
	Properties
	{
		...
		[HideInInspector] m_start_MainHueShift_BabyHairs3 ("Color Adjust--{reference_property:_MainColorAdjustToggle,button_help:{text:Tutorial,action:{type:URL,data:https://www.poiyomi.com/color-and-normals/color-adjust},hover:Documentation}}", Float) = 0
		...
		_MainHueShift_BabyHairs3 ("Hue Shift--{condition_showS:(_MainHueShiftToggle==1)}", Range(0, 1)) = 0
		...
		[HideInInspector] m_end_MainHueShift_BabyHairs3 ("Hue Shift", Float) = 0
 ...
 #define OPTIMIZER_ENABLED 
			...
			float _MainHueShift_BabyHairs3;
			...
			float4 frag(VertexOut i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				{
					float shift = _MainHueShift_BabyHairs3;
					#ifdef POI_AUDIOLINK
