Shader "Hidden/Locked/.poiyomi/Old Versions/8.1/Poiyomi Toon/49446fa2b17c2c44bb828704f600ec62"
{
	Properties
	{
		...
		[HideInInspector] m_start_MainHueShift_BabyHairs4 ("Color Adjust--{reference_property:_MainColorAdjustToggle,button_help:{text:Tutorial,action:{type:URL,data:https://www.poiyomi.com/color-and-normals/color-adjust},hover:Documentation}}", Float) = 0
		...
		_MainHueShift_BabyHairs4 ("Hue Shift--{condition_showS:(_MainHueShiftToggle==1)}", Range(0, 1)) = 0
		...
		[HideInInspector] m_end_MainHueShift_BabyHairs4 ("Hue Shift", Float) = 0
 ...
 #define OPTIMIZER_ENABLED 
			...
			float _MainHueShift_BabyHairs4;
			...
			float4 frag(VertexOut i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				#endif
				poiFragData.baseColor = mainTexture.rgb * poiThemeColor(poiMods, float4(0.2140411,0.2140411,0.2140411,1).rgb, (0.0 /*_ColorThemeIndex*/));
				poiFragData.alpha = mainTexture.a * float4(0.2140411,0.2140411,0.2140411,1).a;
				...
				{
					float shift = _MainHueShift_BabyHairs4;
					#ifdef POI_AUDIOLINK
				...
				poiFragData.baseColor = lerp(poiFragData.baseColor, dot(poiFragData.baseColor, float3(0.3, 0.59, 0.11)), -((0.2 /*_Saturation*/)) * hueShiftAlpha.b);
