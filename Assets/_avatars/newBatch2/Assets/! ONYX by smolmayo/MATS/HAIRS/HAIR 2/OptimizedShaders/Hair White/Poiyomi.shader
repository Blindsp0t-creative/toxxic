Shader "Hidden/Locked/.poiyomi/Old Versions/8.1/Poiyomi Toon/d91456921c733174aa37a7a3a186a673"
{
	Properties
	{
		...
		[HideInInspector] m_start_MainHueShift_HairWhite ("Color Adjust--{reference_property:_MainColorAdjustToggle,button_help:{text:Tutorial,action:{type:URL,data:https://www.poiyomi.com/color-and-normals/color-adjust},hover:Documentation}}", Float) = 0
		...
		_MainHueShift_HairWhite ("Hue Shift--{condition_showS:(_MainHueShiftToggle==1)}", Range(0, 1)) = 0
		...
		[HideInInspector] m_end_MainHueShift_HairWhite ("Hue Shift", Float) = 0
		...
		_MatcapHueShift_HairWhite ("Hue Shift--{condition_showS:(_MatcapHueShiftEnabled==1)}", Range(0, 1)) = 0
 ...
 #define OPTIMIZER_ENABLED 
			...
			float _MatcapHueShift_HairWhite;
			...
			void applyMatcap(inout PoiFragData poiFragData, in PoiCam poiCam, in PoiMesh poiMesh, inout PoiLight poiLight, in PoiMods poiMods)
			{
				...
				{
					matcap.rgb = hueShift(matcap.rgb, _MatcapHueShift_HairWhite + _Time.x * (0.0 /*_MatcapHueShiftSpeed*/));
				}
			...
			float4 frag(VertexOut i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				{
					float shift = _MainHueShift_HairWhite;
					#ifdef POI_AUDIOLINK
