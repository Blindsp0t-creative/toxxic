Shader "Hidden/Locked/.poiyomi/Old Versions/8.1/Poiyomi Toon/8e2a443cc28f32e4d8ebdd8da5844ab0"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			void applyMatcap(inout PoiFragData poiFragData, in PoiCam poiCam, in PoiMesh poiMesh, inout PoiLight poiLight, in PoiMods poiMods)
			{
				...
				if ((0.0 /*_MatcapSmoothnessEnabled*/))
				{
					matcap = UNITY_SAMPLE_TEX2D_SAMPLER_LOD(_Matcap, _MainTex, TRANSFORM_TEX(matcapUV, _Matcap), matcapSmoothness) * float4(poiThemeColor(poiMods, float4(0.5711249,0.6239604,0.7454044,1).rgb, (0.0 /*_MatcapColorThemeIndex*/)), float4(0.5711249,0.6239604,0.7454044,1).a);
				}
				else
				{
					matcap = UNITY_SAMPLE_TEX2D_SAMPLER(_Matcap, _MainTex, TRANSFORM_TEX(matcapUV, _Matcap)) * float4(poiThemeColor(poiMods, float4(0.5711249,0.6239604,0.7454044,1).rgb, (0.0 /*_MatcapColorThemeIndex*/)), float4(0.5711249,0.6239604,0.7454044,1).a);
				}
				#else
				matcap = float4(poiThemeColor(poiMods, float4(0.5711249,0.6239604,0.7454044,1).rgb, (0.0 /*_MatcapColorThemeIndex*/)), float4(0.5711249,0.6239604,0.7454044,1).a);
				#endif
			...
			float4 frag(VertexOut i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				#endif
				poiFragData.baseColor = mainTexture.rgb * poiThemeColor(poiMods, float4(0.4656525,0.6238104,1,1).rgb, (0.0 /*_ColorThemeIndex*/));
				poiFragData.alpha = mainTexture.a * float4(0.4656525,0.6238104,1,1).a;
