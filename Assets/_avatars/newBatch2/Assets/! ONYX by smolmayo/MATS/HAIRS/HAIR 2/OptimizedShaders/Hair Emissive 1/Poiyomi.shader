Shader "Hidden/Locked/.poiyomi/Old Versions/8.1/Poiyomi Toon/6ca6a02602fea6b43ab9708a059d919b"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			{
				poiFragData.alpha = saturate(poiFragData.alpha + (0.11 /*_AlphaMod*/));
			...
			void applyDithering(inout PoiFragData poiFragData, in PoiCam poiCam)
			{
				...
				{
					float dither = calcDither(poiCam.screenUV.xy) - (0.377 /*_AlphaDitherBias*/);
			...
			void applyCubemap(inout PoiFragData poiFragData, in PoiCam poiCam, in PoiMesh poiMesh, in PoiLight poiLight, in PoiMods poiMods)
			{
				...
				cubeMap.rgb *= poiThemeColor(poiMods, float4(0.008023188,0.04305424,0.1356333,1), (0.0 /*_CubeMapColorThemeIndex*/));
				#else
				float4 cubeMap = float4(0.21763764082, 0.21763764082, 0.21763764082, .5) * float4(poiThemeColor(poiMods, float4(0.008023188,0.04305424,0.1356333,1), (0.0 /*_CubeMapColorThemeIndex*/)), 1);
				#endif
				cubeMap.rgb *= (0.72 /*_CubeMapIntensity*/);
				#if defined(PROP_CUBEMAPMASK) || !defined(OPTIMIZER_ENABLED)
				...
				poiFragData.emission += cubeMap.rgb * (1.14 /*_CubeMapEmissionStrength*/) * CubeMapMask * cubeMap.a;
			}
			#endif
			...
			float3 applyEmission3(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiLight poiLight, in PoiCam poiCam, in PoiMods poiMods)
			{
				...
				emissionStrength3 = (3.0 /*_EmissionStrength3*/);
				...
				{
					emissionColor3 = POI2D_SAMPLER_PAN(_EmissionMap3, _MainTex, poiUV(poiMesh.uv[(0.0 /*_EmissionMap3UV*/)], float4(1,1,0,0)), float4(0,0,0,0)) * lerp(1, poiFragData.baseColor, (0.0 /*_EmissionBaseColorAsMap3*/)).rgb * poiThemeColor(poiMods, float4(0.003921571,0.04341898,0.1686275,1).rgb, (0.0 /*_EmissionColor3ThemeIndex*/));
				}
				else
				{
					emissionColor3 = UNITY_SAMPLE_TEX2D_SAMPLER(_EmissionMap3, _MainTex, ((.5 + poiLight.nDotV * .5) * float4(1,1,0,0).xy) + _Time.x * (10.0 /*_EmissionCenterOutSpeed3*/)).rgb * lerp(1, poiFragData.baseColor, (0.0 /*_EmissionBaseColorAsMap3*/)).rgb * poiThemeColor(poiMods, float4(0.003921571,0.04341898,0.1686275,1).rgb, (0.0 /*_EmissionColor3ThemeIndex*/));
				}
				#else
				emissionColor3 = lerp(1, poiFragData.baseColor, (0.0 /*_EmissionBaseColorAsMap3*/)).rgb * poiThemeColor(poiMods, float4(0.003921571,0.04341898,0.1686275,1).rgb, (0.0 /*_EmissionColor3ThemeIndex*/));
				#endif
				...
				{
					emissionStrength3 *= calculateBlinkingEmission((0.0 /*_EmissiveBlink_Min3*/), (0.8 /*_EmissiveBlink_Max3*/), (2.0 /*_EmissiveBlink_Velocity3*/), (0.0 /*_EmissionBlinkingOffset3*/));
				}
			...
			{
				float smoothness = (0.462 /*_MochieRoughnessMultiplier*/);
				...
				specularMask *= (0.173 /*_MochieSpecularStrength*/);
			...
			float4 frag(VertexOut i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				#if defined(PROP_BUMPMAP) || !defined(OPTIMIZER_ENABLED)
				poiMesh.tangentSpaceNormal = UnpackScaleNormal(POI2D_SAMPLER_PAN_STOCHASTIC(_BumpMap, _MainTex, poiUV(poiMesh.uv[(0.0 /*_BumpMapUV*/)].xy, float4(2,1,0,0)), float4(0,0,0,0), (0.0 /*_BumpMapStochastic*/)), (3.56 /*_BumpScale*/));
				#else
