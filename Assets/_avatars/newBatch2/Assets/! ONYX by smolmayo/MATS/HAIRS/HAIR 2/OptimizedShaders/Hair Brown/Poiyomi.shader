Shader "Hidden/Locked/.poiyomi/Old Versions/8.1/Poiyomi Toon/65a097b0ad9c8c74a8fb0d0a4318189a"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			void applyMatcap(inout PoiFragData poiFragData, in PoiCam poiCam, in PoiMesh poiMesh, inout PoiLight poiLight, in PoiMods poiMods)
			{
				...
				if ((0.0 /*_MatcapSmoothnessEnabled*/))
				{
					matcap = UNITY_SAMPLE_TEX2D_SAMPLER_LOD(_Matcap, _MainTex, TRANSFORM_TEX(matcapUV, _Matcap), matcapSmoothness) * float4(poiThemeColor(poiMods, float4(0.5583405,0.48515,0.4019779,1).rgb, (0.0 /*_MatcapColorThemeIndex*/)), float4(0.5583405,0.48515,0.4019779,1).a);
				}
				else
				{
					matcap = UNITY_SAMPLE_TEX2D_SAMPLER(_Matcap, _MainTex, TRANSFORM_TEX(matcapUV, _Matcap)) * float4(poiThemeColor(poiMods, float4(0.5583405,0.48515,0.4019779,1).rgb, (0.0 /*_MatcapColorThemeIndex*/)), float4(0.5583405,0.48515,0.4019779,1).a);
				}
				#else
				matcap = float4(poiThemeColor(poiMods, float4(0.5583405,0.48515,0.4019779,1).rgb, (0.0 /*_MatcapColorThemeIndex*/)), float4(0.5583405,0.48515,0.4019779,1).a);
				#endif
