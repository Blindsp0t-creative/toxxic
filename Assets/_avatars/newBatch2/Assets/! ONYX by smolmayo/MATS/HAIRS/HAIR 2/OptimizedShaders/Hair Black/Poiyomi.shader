Shader "Hidden/Locked/.poiyomi/Old Versions/8.1/Poiyomi Toon/d5da0eeae6742594094a25a0dd1f1716"
{
	Properties
	{
		...
		[HideInInspector] m_start_MainHueShift_HairBlack ("Color Adjust--{reference_property:_MainColorAdjustToggle,button_help:{text:Tutorial,action:{type:URL,data:https://www.poiyomi.com/color-and-normals/color-adjust},hover:Documentation}}", Float) = 0
		...
		_MainHueShift_HairBlack ("Hue Shift--{condition_showS:(_MainHueShiftToggle==1)}", Range(0, 1)) = 0
		...
		[HideInInspector] m_end_MainHueShift_HairBlack ("Hue Shift", Float) = 0
		...
		_MatcapHueShift_HairBlack ("Hue Shift--{condition_showS:(_MatcapHueShiftEnabled==1)}", Range(0, 1)) = 0
 ...
 #define OPTIMIZER_ENABLED 
			...
			float _MatcapHueShift_HairBlack;
			...
			void applyMatcap(inout PoiFragData poiFragData, in PoiCam poiCam, in PoiMesh poiMesh, inout PoiLight poiLight, in PoiMods poiMods)
			{
				...
				if ((0.0 /*_MatcapSmoothnessEnabled*/))
				{
					matcap = UNITY_SAMPLE_TEX2D_SAMPLER_LOD(_Matcap, _MainTex, TRANSFORM_TEX(matcapUV, _Matcap), matcapSmoothness) * float4(poiThemeColor(poiMods, float4(0.4320358,0.4320358,0.4320358,1).rgb, (0.0 /*_MatcapColorThemeIndex*/)), float4(0.4320358,0.4320358,0.4320358,1).a);
				}
				else
				{
					matcap = UNITY_SAMPLE_TEX2D_SAMPLER(_Matcap, _MainTex, TRANSFORM_TEX(matcapUV, _Matcap)) * float4(poiThemeColor(poiMods, float4(0.4320358,0.4320358,0.4320358,1).rgb, (0.0 /*_MatcapColorThemeIndex*/)), float4(0.4320358,0.4320358,0.4320358,1).a);
				}
				#else
				matcap = float4(poiThemeColor(poiMods, float4(0.4320358,0.4320358,0.4320358,1).rgb, (0.0 /*_MatcapColorThemeIndex*/)), float4(0.4320358,0.4320358,0.4320358,1).a);
				#endif
				...
				{
					matcap.rgb = hueShift(matcap.rgb, _MatcapHueShift_HairBlack + _Time.x * (0.0 /*_MatcapHueShiftSpeed*/));
				}
			...
			float4 frag(VertexOut i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				#if defined(PROP_BUMPMAP) || !defined(OPTIMIZER_ENABLED)
				poiMesh.tangentSpaceNormal = UnpackScaleNormal(POI2D_SAMPLER_PAN_STOCHASTIC(_BumpMap, _MainTex, poiUV(poiMesh.uv[(0.0 /*_BumpMapUV*/)].xy, float4(4,4,0,0)), float4(0,0,0,0), (0.0 /*_BumpMapStochastic*/)), (1.5 /*_BumpScale*/));
				#else
				...
				{
					float shift = _MainHueShift_HairBlack;
					#ifdef POI_AUDIOLINK
