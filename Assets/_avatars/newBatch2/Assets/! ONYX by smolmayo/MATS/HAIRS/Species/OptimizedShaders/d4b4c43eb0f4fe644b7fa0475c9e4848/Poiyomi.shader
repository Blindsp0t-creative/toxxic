Shader "Hidden/Locked/.poiyomi/Old Versions/8.1/Poiyomi Toon/d4b4c43eb0f4fe644b7fa0475c9e4848"
{
	Properties
	{
		...
		[HideInInspector] m_start_MainHueShift_CatAcc ("Color Adjust--{reference_property:_MainColorAdjustToggle,button_help:{text:Tutorial,action:{type:URL,data:https://www.poiyomi.com/color-and-normals/color-adjust},hover:Documentation}}", Float) = 0
		...
		_MainHueShift_CatAcc ("Hue Shift--{condition_showS:(_MainHueShiftToggle==1)}", Range(0, 1)) = 0
		...
		[HideInInspector] m_end_MainHueShift_CatAcc ("Hue Shift", Float) = 0
 ...
 #define OPTIMIZER_ENABLED 
			...
			void applyMatcap(inout PoiFragData poiFragData, in PoiCam poiCam, in PoiMesh poiMesh, inout PoiLight poiLight, in PoiMods poiMods)
			{
				...
				blendMatcap(poiLight, poiFragData, poiMods, (0.0 /*_Matcap3Add*/), (0.0 /*_Matcap3AddToLight*/), (1.0 /*_Matcap3Multiply*/), (1.0 /*_Matcap3Replace*/), (1.0 /*_Matcap3Mixed*/), (0.0 /*_Matcap3Screen*/), matcap3, matcap3Mask, (0.0 /*_Matcap3EmissionStrength*/), (0.0 /*_Matcap3LightMask*/), (0.0 /*_Matcap3MaskGlobalMask*/), (2.0 /*_Matcap3MaskGlobalMaskBlendType*/));
				#endif
			}
			#endif
			#ifdef _CUBEMAP
			...
			void applyCubemap(inout PoiFragData poiFragData, in PoiCam poiCam, in PoiMesh poiMesh, in PoiLight poiLight, in PoiMods poiMods)
			{
				...
				#endif
				cubeMap.rgb *= (0.12 /*_CubeMapIntensity*/);
				#if defined(PROP_CUBEMAPMASK) || !defined(OPTIMIZER_ENABLED)
				...
				poiFragData.baseColor.rgb = lerp(poiFragData.baseColor.rgb, cubeMap.rgb, (0.054 /*_CubeMapReplace*/) * CubeMapMask * cubeMap.a);
			...
			float4 frag(VertexOut i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				{
					float shift = _MainHueShift_CatAcc;
					#ifdef POI_AUDIOLINK
