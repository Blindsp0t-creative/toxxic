Shader "Hidden/Locked/.poiyomi/Old Versions/8.1/Poiyomi Toon/35163cc525a8e4b4992dcc545bfc4c95"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			void applyCubemap(inout PoiFragData poiFragData, in PoiCam poiCam, in PoiMesh poiMesh, in PoiLight poiLight, in PoiMods poiMods)
			{
				...
				poiFragData.baseColor.rgb = lerp(poiFragData.baseColor.rgb, cubeMap.rgb, (0.375 /*_CubeMapReplace*/) * CubeMapMask * cubeMap.a);
