Shader "Hidden/Locked/.poiyomi/Poiyomi Toon/8962117ab913c66489821a6bdddf6573"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			void applyAlphaOptions(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiCam poiCam, in PoiMods poiMods)
			{
				...
				{
					float holoRim = saturate(1 - smoothstep(min((0.296 /*_AlphaFresnelSharpness*/), (1.0 /*_AlphaFresnelWidth*/)), (1.0 /*_AlphaFresnelWidth*/), (poiCam.vDotN)));
					holoRim = abs(lerp(1, holoRim, (0.08 /*_AlphaFresnelAlpha*/)));
