Shader "Hidden/Locked/.poiyomi/Old Versions/8.1/Poiyomi Toon Outline/8fb19fcc517ebdb4d8a5d03da6533f84"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			void applyDissolve(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiMods poiMods, in PoiCam poiCam, in PoiLight poiLight)
			{
				...
				#endif
				#if defined(PROP_DISSOLVENOISETEXTURE) || !defined(OPTIMIZER_ENABLED)
				float dissolveNoiseTexture = POI2D_SAMPLER_PAN(_DissolveNoiseTexture, _MainTex, poiUV(poiMesh.uv[(0.0 /*_DissolveNoiseTextureUV*/)], float4(1,1,0,0)), float4(1.2,1.2,0,0)).r;
				#else
