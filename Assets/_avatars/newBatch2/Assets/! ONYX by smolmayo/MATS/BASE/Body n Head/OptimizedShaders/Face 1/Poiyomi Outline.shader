Shader "Hidden/Locked/.poiyomi/Old Versions/8.1/Poiyomi Toon Outline/1c282a31e3e2d364c91b8fe5c5f2650a"
{
	Properties
	{
		...
		_Matcap3Intensity_Face1 ("Intensity", Range(0, 5)) = 1
		_Matcap3LightMask ("Hide in Shadow", Range(0, 1)) = 0
		_Matcap3Replace_Face1 ("Replace Blend", Range(0, 1)) = 0
 ...
 #define OPTIMIZER_ENABLED 
			...
			float _Matcap3Intensity_Face1;
			float _Matcap3Replace_Face1;
			...
			void applyMatcap(inout PoiFragData poiFragData, in PoiCam poiCam, in PoiMesh poiMesh, inout PoiLight poiLight, in PoiMods poiMods)
			{
				...
				#endif
				matcap3.rgb *= _Matcap3Intensity_Face1;
				...
				blendMatcap(poiLight, poiFragData, poiMods, (0.062 /*_Matcap3Add*/), (0.0 /*_Matcap3AddToLight*/), (0.0 /*_Matcap3Multiply*/), _Matcap3Replace_Face1, (0.0 /*_Matcap3Mixed*/), (0.0 /*_Matcap3Screen*/), matcap3, matcap3Mask, (0.0 /*_Matcap3EmissionStrength*/), (0.0 /*_Matcap3LightMask*/), (0.0 /*_Matcap3MaskGlobalMask*/), (2.0 /*_Matcap3MaskGlobalMaskBlendType*/));
				#endif
				#ifdef POI_MATCAP3
