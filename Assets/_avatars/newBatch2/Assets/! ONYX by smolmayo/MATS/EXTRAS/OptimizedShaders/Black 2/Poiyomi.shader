Shader "Hidden/Locked/.poiyomi/Old Versions/8.1/Poiyomi Toon/9430afe8c8ee5a342ab9b773b33ba6d3"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			void applyDissolve(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiMods poiMods, in PoiCam poiCam, in PoiLight poiLight)
			{
				...
				#if defined(PROP_DISSOLVETOTEXTURE) || !defined(OPTIMIZER_ENABLED)
				dissolveToTexture = POI2D_SAMPLER_PAN(_DissolveToTexture, _MainTex, poiUV(poiMesh.uv[(0.0 /*_DissolveToTextureUV*/)], _DissolveToTexture_ST), float4(0,0,0,0)) * float4(poiThemeColor(poiMods, float4(0,0.7687256,1,0).rgb, (0.0 /*_DissolveTextureColorThemeIndex*/)), float4(0,0.7687256,1,0).a);
				#else
				dissolveToTexture = float4(0,0.7687256,1,0);
				#endif
				#if defined(PROP_DISSOLVENOISETEXTURE) || !defined(OPTIMIZER_ENABLED)
				...
				{
					edgeColor = tex2D(_DissolveEdgeGradient, poiUV(float2(edgeAlpha, edgeAlpha), float4(1,1,0,0))) * float4(poiThemeColor(poiMods, float4(0.01480526,0.53087,1,1).rgb, (0.0 /*_DissolveEdgeColorThemeIndex*/)), float4(0.01480526,0.53087,1,1).a);
					#ifndef POI_SHADOW
			...
			void applyMatcap(inout PoiFragData poiFragData, in PoiCam poiCam, in PoiMesh poiMesh, inout PoiLight poiLight, in PoiMods poiMods)
			{
				...
				if ((0.0 /*_MatcapSmoothnessEnabled*/))
				{
					matcap = UNITY_SAMPLE_TEX2D_SAMPLER_LOD(_Matcap, _MainTex, TRANSFORM_TEX(matcapUV, _Matcap), matcapSmoothness) * float4(poiThemeColor(poiMods, float4(0.2319224,0.2319224,0.2319224,1).rgb, (0.0 /*_MatcapColorThemeIndex*/)), float4(0.2319224,0.2319224,0.2319224,1).a);
				}
				else
				{
					matcap = UNITY_SAMPLE_TEX2D_SAMPLER(_Matcap, _MainTex, TRANSFORM_TEX(matcapUV, _Matcap)) * float4(poiThemeColor(poiMods, float4(0.2319224,0.2319224,0.2319224,1).rgb, (0.0 /*_MatcapColorThemeIndex*/)), float4(0.2319224,0.2319224,0.2319224,1).a);
				}
				#else
				matcap = float4(poiThemeColor(poiMods, float4(0.2319224,0.2319224,0.2319224,1).rgb, (0.0 /*_MatcapColorThemeIndex*/)), float4(0.2319224,0.2319224,0.2319224,1).a);
				#endif
				matcap.rgb *= (1.48 /*_MatcapIntensity*/);
				...
				blendMatcap(poiLight, poiFragData, poiMods, (1.0 /*_MatcapAdd*/), (0.0 /*_MatcapAddToLight*/), (1.0 /*_MatcapMultiply*/), (1.0 /*_MatcapReplace*/), (0.0 /*_MatcapMixed*/), (0.0 /*_MatcapScreen*/), matcap, matcapMask, (0.0 /*_MatcapEmissionStrength*/), (0.0 /*_MatcapLightMask*/), (0.0 /*_MatcapMaskGlobalMask*/), (2.0 /*_MatcapMaskGlobalMaskBlendType*/));
				#endif
				#ifdef COLOR_GRADING_HDR_3D
			...
			{
				float smoothness = (0.212 /*_MochieRoughnessMultiplier*/);
				float smoothness2 = (1.0 /*_MochieRoughnessMultiplier2*/);
				float metallic = (0.244 /*_MochieMetallicMultiplier*/);
				...
				specularMask *= (0.882 /*_MochieSpecularStrength*/);
			...
			float4 frag(VertexOut i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				#if defined(PROP_BUMPMAP) || !defined(OPTIMIZER_ENABLED)
				poiMesh.tangentSpaceNormal = UnpackScaleNormal(POI2D_SAMPLER_PAN_STOCHASTIC(_BumpMap, _MainTex, poiUV(poiMesh.uv[(0.0 /*_BumpMapUV*/)].xy, float4(10,10,0,0)), float4(0,0,0,0), (0.0 /*_BumpMapStochastic*/)), (0.34 /*_BumpScale*/));
				#else
				...
				{
					poiLight.directColor = min(poiLight.directColor, (0.55 /*_LightingCap*/));
					poiLight.indirectColor = min(poiLight.indirectColor, (0.55 /*_LightingCap*/));
				}
