Shader "Hidden/Locked/.poiyomi/Old Versions/8.1/Poiyomi Toon/707648c4ee3840b4a896d0ef7cb8b261"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			void applyMatcap(inout PoiFragData poiFragData, in PoiCam poiCam, in PoiMesh poiMesh, inout PoiLight poiLight, in PoiMods poiMods)
			{
				...
				blendMatcap(poiLight, poiFragData, poiMods, (0.11 /*_MatcapAdd*/), (0.0 /*_MatcapAddToLight*/), (0.107 /*_MatcapMultiply*/), (0.0 /*_MatcapReplace*/), (0.0 /*_MatcapMixed*/), (0.0 /*_MatcapScreen*/), matcap, matcapMask, (0.0 /*_MatcapEmissionStrength*/), (0.0 /*_MatcapLightMask*/), (0.0 /*_MatcapMaskGlobalMask*/), (2.0 /*_MatcapMaskGlobalMaskBlendType*/));
				#endif
				#ifdef COLOR_GRADING_HDR_3D
				...
				#endif
				matcap2.rgb *= (1.35 /*_Matcap2Intensity*/);
				...
				blendMatcap(poiLight, poiFragData, poiMods, (1.0 /*_Matcap2Add*/), (0.0 /*_Matcap2AddToLight*/), (0.618 /*_Matcap2Multiply*/), (1.0 /*_Matcap2Replace*/), (0.0 /*_Matcap2Mixed*/), (0.0 /*_Matcap2Screen*/), matcap2, matcap2Mask, (0.0 /*_Matcap2EmissionStrength*/), (0.0 /*_Matcap2LightMask*/), (0.0 /*_Matcap2MaskGlobalMask*/), (2.0 /*_Matcap2MaskGlobalMaskBlendType*/));
				#endif
				#ifdef POI_MATCAP2
				...
				#endif
				matcap3.rgb *= (1.29 /*_Matcap3Intensity*/);
				...
				blendMatcap(poiLight, poiFragData, poiMods, (0.0 /*_Matcap3Add*/), (0.0 /*_Matcap3AddToLight*/), (1.0 /*_Matcap3Multiply*/), (0.376 /*_Matcap3Replace*/), (0.0 /*_Matcap3Mixed*/), (0.0 /*_Matcap3Screen*/), matcap3, matcap3Mask, (0.0 /*_Matcap3EmissionStrength*/), (0.0 /*_Matcap3LightMask*/), (0.0 /*_Matcap3MaskGlobalMask*/), (2.0 /*_Matcap3MaskGlobalMaskBlendType*/));
				#endif
			}
			#endif
			...
			{
				float2 st = frac(poiMesh.uv[(0.0 /*_GlitterUV*/)] + float4(0,0,0,0).xy * _Time.x) * (10000.0 /*_GlitterFrequency*/);
				...
				switch((0.0 /*_GlitterMode*/))
				{
					...
					finalGlitter = lerp(0, (0.0 /*_GlitterMinBrightness*/) * glitterAlpha, glitterAlpha) + max(pow(saturate(dot(lerp(glitterReflectionDirection, poiCam.viewDir, (0.5 /*_GlitterBias*/)), poiCam.viewDir)), (400.0 /*_GlitterContrast*/)), 0);
					...
					finalGlitter = lerp(0, (0.0 /*_GlitterMinBrightness*/) * glitterAlpha, glitterAlpha) + max(pow(specAngle, (400.0 /*_GlitterContrast*/)), 0);
					glitterColor *= poiLight.directColor;
					finalGlitter *= glitterAlpha;
					break;
				}
				glitterColor *= lerp(1, poiFragData.baseColor, (0.883 /*_GlitterUseSurfaceColor*/));
				#if defined(PROP_GLITTERCOLORMAP) || !defined(OPTIMIZER_ENABLED)
				...
				{
					poiFragData.baseColor = lerp(poiFragData.baseColor, finalGlitter * glitterColor * (0.35 /*_GlitterBrightness*/), finalGlitter * glitterTexture.a * glitterMask);
					poiFragData.emission += finalGlitter * glitterColor * max(0, ((0.35 /*_GlitterBrightness*/) - 1) * glitterTexture.a) * glitterMask;
				}
				else
				{
					poiFragData.emission += finalGlitter * glitterColor * (0.35 /*_GlitterBrightness*/) * glitterTexture.a * glitterMask;
				}
			}
			#endif
