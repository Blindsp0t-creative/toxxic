Shader "Hidden/Locked/.poiyomi/Old Versions/8.1/Poiyomi Toon/d4dd3fcd02f314b44940ae8713e0c0db"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			void applyCubemap(inout PoiFragData poiFragData, in PoiCam poiCam, in PoiMesh poiMesh, in PoiLight poiLight, in PoiMods poiMods)
			{
				...
				#endif
				cubeMap.rgb *= (2.05 /*_CubeMapIntensity*/);
				#if defined(PROP_CUBEMAPMASK) || !defined(OPTIMIZER_ENABLED)
				...
				poiFragData.baseColor.rgb = lerp(poiFragData.baseColor.rgb, cubeMap.rgb, (0.508 /*_CubeMapReplace*/) * CubeMapMask * cubeMap.a);
