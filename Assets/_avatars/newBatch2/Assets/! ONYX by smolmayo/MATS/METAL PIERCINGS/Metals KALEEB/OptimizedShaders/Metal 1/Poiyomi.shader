Shader "Hidden/Locked/.poiyomi/Old Versions/8.1/Poiyomi Toon/9cfaaf9eb4f8b90429b99416589a468d"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			void applyCubemap(inout PoiFragData poiFragData, in PoiCam poiCam, in PoiMesh poiMesh, in PoiLight poiLight, in PoiMods poiMods)
			{
				...
				cubeMap.rgb *= poiThemeColor(poiMods, float4(0.02968646,0.02968646,0.02968646,1), (0.0 /*_CubeMapColorThemeIndex*/));
				#else
				float4 cubeMap = float4(0.21763764082, 0.21763764082, 0.21763764082, .5) * float4(poiThemeColor(poiMods, float4(0.02968646,0.02968646,0.02968646,1), (0.0 /*_CubeMapColorThemeIndex*/)), 1);
				#endif
