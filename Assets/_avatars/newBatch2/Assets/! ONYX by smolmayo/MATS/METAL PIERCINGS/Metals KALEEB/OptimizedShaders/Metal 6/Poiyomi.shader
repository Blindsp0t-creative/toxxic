Shader "Hidden/Locked/.poiyomi/Old Versions/8.1/Poiyomi Toon/d990ed18fc39a8e458036cda2dfc886d"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			void applyCubemap(inout PoiFragData poiFragData, in PoiCam poiCam, in PoiMesh poiMesh, in PoiLight poiLight, in PoiMods poiMods)
			{
				...
				cubeMap.rgb *= poiThemeColor(poiMods, float4(0.007413972,0.04290124,0.09441278,1), (0.0 /*_CubeMapColorThemeIndex*/));
				#else
				float4 cubeMap = float4(0.21763764082, 0.21763764082, 0.21763764082, .5) * float4(poiThemeColor(poiMods, float4(0.007413972,0.04290124,0.09441278,1), (0.0 /*_CubeMapColorThemeIndex*/)), 1);
				#endif
				cubeMap.rgb *= (2.65 /*_CubeMapIntensity*/);
				#if defined(PROP_CUBEMAPMASK) || !defined(OPTIMIZER_ENABLED)
				...
				poiFragData.baseColor.rgb += cubeMap.rgb * (0.23 /*_CubeMapAdd*/) * CubeMapMask * cubeMap.a;
			...
			{
				float smoothness = (0.757 /*_MochieRoughnessMultiplier*/);
				float smoothness2 = (1.0 /*_MochieRoughnessMultiplier2*/);
				float metallic = (0.72 /*_MochieMetallicMultiplier*/);
			...
			float4 frag(VertexOut i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				#endif
				poiFragData.baseColor = mainTexture.rgb * poiThemeColor(poiMods, float4(0,0,0,0.9960784).rgb, (0.0 /*_ColorThemeIndex*/));
				poiFragData.alpha = mainTexture.a * float4(0,0,0,0.9960784).a;
