Shader "Hidden/Locked/.poiyomi/Old Versions/8.1/Poiyomi Toon/bfe0784e3159c0b4c89cf796d84081d4"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			void calculateShading(inout PoiLight poiLight, inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiCam poiCam)
			{
				...
				else if ((0.0 /*_LightingAdditiveType*/) == 1) // Toon
				{
					...
					#endif
					if ((0.224 /*_LightingAdditiveGradientEnd*/) == (0.0 /*_LightingAdditiveGradientStart*/)) (0.224 /*_LightingAdditiveGradientEnd*/) += 0.001;
					poiLight.rampedLightMap = smoothstep((0.224 /*_LightingAdditiveGradientEnd*/), (0.0 /*_LightingAdditiveGradientStart*/), 1 - (.5 * poiLight.nDotL + .5));
					#if defined(POINT) || defined(SPOT)
					poiLight.finalLighting = lerp(poiLight.directColor * max(min(poiLight.additiveShadow, poiLight.detailShadow), passthrough), poiLight.indirectColor, smoothstep((0.0 /*_LightingAdditiveGradientStart*/), (0.224 /*_LightingAdditiveGradientEnd*/), 1 - (.5 * poiLight.nDotL + .5))) * poiLight.attenuation;
					#else
					poiLight.finalLighting = lerp(poiLight.directColor * max(min(poiLight.attenuation, poiLight.detailShadow), passthrough), poiLight.indirectColor, smoothstep((0.0 /*_LightingAdditiveGradientStart*/), (0.224 /*_LightingAdditiveGradientEnd*/), 1 - (.5 * poiLight.nDotL + .5)));
					#endif
					return;
				}
				#endif
				...
				if ((1.0 /*_LightingVertexLightingEnabled*/))
				{
					...
					for (int index = 0; index < 4; index++)
					{
						...
						{
							vertexLighting += lerp(poiLight.vColor[index] * poiLight.vAttenuation[index], poiLight.vColor[index] * (0.5 /*_LightingAdditivePassthrough*/) * poiLight.vAttenuation[index], smoothstep((0.0 /*_LightingAdditiveGradientStart*/), (0.224 /*_LightingAdditiveGradientEnd*/), 1 - (.5 * poiLight.vDotNL[index] + .5))) * poiLight.detailShadow;
						}
					}
			...
			void applyMatcap(inout PoiFragData poiFragData, in PoiCam poiCam, in PoiMesh poiMesh, inout PoiLight poiLight, in PoiMods poiMods)
			{
				...
				if ((0.0 /*_Matcap4SmoothnessEnabled*/))
				{
					matcap4 = UNITY_SAMPLE_TEX2D_SAMPLER_LOD(_Matcap4, _MainTex, TRANSFORM_TEX(matcapUV, _Matcap4), matcap4Smoothness) * float4(poiThemeColor(poiMods, float4(1,0.8227859,0.4677838,1).rgb, (0.0 /*_Matcap4ColorThemeIndex*/)), float4(1,0.8227859,0.4677838,1).a);
				}
				else
				{
					matcap4 = UNITY_SAMPLE_TEX2D_SAMPLER(_Matcap4, _MainTex, TRANSFORM_TEX(matcapUV, _Matcap4)) * float4(poiThemeColor(poiMods, float4(1,0.8227859,0.4677838,1).rgb, (0.0 /*_Matcap4ColorThemeIndex*/)), float4(1,0.8227859,0.4677838,1).a);
				}
				#else
				matcap4 = float4(poiThemeColor(poiMods, float4(1,0.8227859,0.4677838,1).rgb, (0.0 /*_Matcap4ColorThemeIndex*/)), float4(1,0.8227859,0.4677838,1).a);
				#endif
				matcap4.rgb *= (1.0 /*_Matcap4Intensity*/);
				...
				if ((1.0 /*_Matcap4HueShiftEnabled*/))
				{
					matcap4.rgb = hueShift(matcap4.rgb, _Matcap4HueShift + _Time.x * (0.0 /*_Matcap4HueShiftSpeed*/));
				}
				blendMatcap(poiLight, poiFragData, poiMods, (1.0 /*_Matcap4Add*/), (0.0 /*_Matcap4AddToLight*/), (0.798 /*_Matcap4Multiply*/), (0.0 /*_Matcap4Replace*/), (0.0 /*_Matcap4Mixed*/), (0.0 /*_Matcap4Screen*/), matcap4, matcap4Mask, (0.0 /*_Matcap4EmissionStrength*/), (0.0 /*_Matcap4LightMask*/), (0.0 /*_Matcap4MaskGlobalMask*/), (2.0 /*_Matcap4MaskGlobalMaskBlendType*/));
				#endif
			}
			#endif
			...
			void MochieBRDF(inout PoiFragData poiFragData, in PoiCam poiCam, inout PoiLight poiLight, in PoiMesh poiMesh, inout PoiMods poiMods)
			{
				...
				float3 reflCol = GetReflections(poiCam, poiLight, poiMesh, roughness, (1.0 /*_MochieForceFallback*/), (0.0 /*_MochieLitFallback*/), _MochieReflCube, _MochieReflCube_HDR, pbrReflectionDir);
				reflections = surfaceReduction * reflCol * lerp(1, FresnelLerp(specCol, grazingTerm, pbrNDotV), (1.0 /*_RefSpecFresnel*/));
				reflections *= poiThemeColor(poiMods, float4(0.5911142,0.5911142,0.5911142,1), (0.0 /*_MochieReflectionTintThemeIndex*/));
