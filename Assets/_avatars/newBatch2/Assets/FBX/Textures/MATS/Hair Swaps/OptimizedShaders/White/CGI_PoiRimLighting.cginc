...
void applyRimLighting(inout float4 albedo, inout float3 rimLightEmission)
{
    ...
    float rimWidth = lerp( - .05, 1, (0.238 /*_RimWidth*/));
    #ifdef POI_AUDIOLINK
    ...
    rimLightEmission = rim * lerp(albedo, rimColor, (0.32 /*_RimLightColorBias*/)) * rimStrength;
    albedo.rgb = lerp(albedo.rgb, lerp(albedo.rgb, rimColor, (0.32 /*_RimLightColorBias*/)) + lerp(albedo.rgb, rimColor, (0.32 /*_RimLightColorBias*/)) * rimBrighten, rim);
}
#endif
