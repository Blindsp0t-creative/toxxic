...
void applyRimLighting(inout float4 albedo, inout float3 rimLightEmission)
{
    ...
    #endif
    #if defined(PROP_RIMTEX) || !defined(OPTIMIZER_ENABLED)
        rimColor = POI2D_SAMPLER_PAN(_RimTex, _MainTex, poiMesh.uv[(0.0 /*_RimTexUV*/)], float4(0,0,0,0)) * float4(0.1729492,0.1729492,0.1729492,1);
    #else
        rimColor = float4(0.1729492,0.1729492,0.1729492,1);
    #endif
