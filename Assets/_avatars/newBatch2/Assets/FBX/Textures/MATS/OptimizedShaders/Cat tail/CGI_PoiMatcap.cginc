    ...
    void applyMatcap(inout float4 finalColor, inout float3 matcapEmission)
    {
        ...
        #if defined(PROP_MATCAP) || !defined(OPTIMIZER_ENABLED)
            matcap = UNITY_SAMPLE_TEX2D_SAMPLER(_Matcap, _MainTex, TRANSFORM_TEX(matcapUV, _Matcap)) * float4(0.09441278,0.09441278,0.09441278,1);
        #else
            matcap = float4(0.09441278,0.09441278,0.09441278,1);
        #endif
        matcap.rgb *= (2.65 /*_MatcapIntensity*/);
        #if defined(PROP_MATCAPMASK) || !defined(OPTIMIZER_ENABLED)
        ...
        blendMatcap(finalColor, (1.0 /*_MatcapAdd*/), (1.0 /*_MatcapMultiply*/), (1.0 /*_MatcapReplace*/), matcap, matcapMask, matcapEmission, (0.0 /*_MatcapEmissionStrength*/)
        #ifdef POI_LIGHTING
