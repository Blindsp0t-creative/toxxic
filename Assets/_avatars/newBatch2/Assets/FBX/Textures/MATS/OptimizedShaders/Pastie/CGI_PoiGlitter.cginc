    ...
    float3 randomFloat3WiggleRange(float2 Seed, float Range)
    {
        ...
        float speed = 1 + (10.0 /*_GlitterSpeed*/);
    ...
    {
        float2 st = frac(poiMesh.uv[0] + float4(0,0,0,0).xy * _Time.x) * (2000.0 /*_GlitterFrequency*/);
        ...
        switch((0.0 /*_GlitterMode*/))
        {
            ...
            {
                randomRotation = randomFloat3WiggleRange(randoPoint, (0.0 /*_GlitterAngleRange*/));
            }
            else
            {
            ...
            finalGlitter = lerp(0, (0.0 /*_GlitterMinBrightness*/) * glitterAlpha, glitterAlpha) + max(pow(saturate(dot(lerp(glitterReflectionDirection, poiCam.viewDir, (0.8 /*_GlitterBias*/)), poiCam.viewDir)), (1000.0 /*_GlitterContrast*/)), 0);
        ...
        half3 glitterColor = float4(0,1,0.5942535,1);
        ...
        {
            albedo.rgb = lerp(albedo.rgb, finalGlitter * glitterColor * (1.3 /*_GlitterBrightness*/), finalGlitter * glitterTexture.a * glitterMask);
            glitterEmission = finalGlitter * glitterColor * max(0, ((1.3 /*_GlitterBrightness*/) - 1) * glitterTexture.a) * glitterMask;
        }
        else
        {
            glitterEmission = finalGlitter * glitterColor * (1.3 /*_GlitterBrightness*/) * glitterTexture.a * glitterMask;
        }
    }
#endif
