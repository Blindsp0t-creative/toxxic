    ...
    void applyGlitter(inout float4 albedo, inout float3 glitterEmission)
    {
        ...
        {
            albedo.rgb = lerp(albedo.rgb, finalGlitter * glitterColor * (1.8 /*_GlitterBrightness*/), finalGlitter * glitterTexture.a * glitterMask);
            glitterEmission = finalGlitter * glitterColor * max(0, ((1.8 /*_GlitterBrightness*/) - 1) * glitterTexture.a) * glitterMask;
        }
        else
        {
            glitterEmission = finalGlitter * glitterColor * (1.8 /*_GlitterBrightness*/) * glitterTexture.a * glitterMask;
        }
    }
#endif
