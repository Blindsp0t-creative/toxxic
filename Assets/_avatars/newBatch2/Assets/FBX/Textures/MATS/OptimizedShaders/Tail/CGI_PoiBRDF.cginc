...
void poiBRDF(inout float4 finalColor, const float4 finalColorBeforeLighting)
{
    ...
    float metallic = metallicGlossMap.r * (0.973 /*_BRDFMetallic*/);
    float reflectance = metallicGlossMap.g * (0.5 /*_BRDFReflectance*/);
    float roughness = max(1 - ((0.495 /*_BRDFGlossiness*/) * metallicGlossMap.a), getGeometricSpecularAA(poiMesh.normals[1]));
