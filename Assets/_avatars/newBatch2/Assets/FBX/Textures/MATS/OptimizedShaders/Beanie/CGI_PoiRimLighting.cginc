...
void applyRimLighting(inout float4 albedo, inout float3 rimLightEmission)
{
    ...
    rimLightEmission = rim * lerp(albedo, rimColor, (0.842 /*_RimLightColorBias*/)) * rimStrength;
    albedo.rgb = lerp(albedo.rgb, lerp(albedo.rgb, rimColor, (0.842 /*_RimLightColorBias*/)) + lerp(albedo.rgb, rimColor, (0.842 /*_RimLightColorBias*/)) * rimBrighten, rim);
}
#endif
