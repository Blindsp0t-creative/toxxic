...
void applyRimLighting(inout float4 albedo, inout float3 rimLightEmission)
{
    ...
    float rimStrength = (5.37 /*_RimStrength*/);
    float rimBrighten = (0.0 /*_RimBrighten*/);
    float rimWidth = lerp( - .05, 1, (0.89 /*_RimWidth*/));
    #ifdef POI_AUDIOLINK
    ...
    #endif
    #if defined(PROP_RIMTEX) || !defined(OPTIMIZER_ENABLED)
        rimColor = POI2D_SAMPLER_PAN(_RimTex, _MainTex, poiMesh.uv[(0.0 /*_RimTexUV*/)], float4(0,0,0,0)) * float4(0.004895449,1,0,1);
    #else
        rimColor = float4(0.004895449,1,0,1);
    #endif
    ...
    rim *= float4(0.004895449,1,0,1).a * rimColor.a * rimMask;
