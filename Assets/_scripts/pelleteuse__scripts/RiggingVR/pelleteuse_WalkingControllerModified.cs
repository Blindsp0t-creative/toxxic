...
public class pelleteuse_WalkingControllerModified: MonoBehaviour
{
    [SerializeField]
    ...
    private void Update() //FixedUpdate()
    {
        ...
        // var eulerRot = new pelleteuse_Vector3(Mathf.DeltaAngle(0, deltaRot.eulerAngles.x), Mathf.DeltaAngle(0, deltaRot.eulerAngles.y), Mathf.DeltaAngle(0, deltaRot.eulerAngles.z));
