...
[CustomEditor(typeof(pelleteuse_conduite_script03))]

public class conduiteScriptEditorPeleteuse : Editor
{
    pelleteuse_conduite_script03 _target;

    void OnEnable()
    {
        //ref to parent script
        _target = (pelleteuse_conduite_script03)target;
    }
